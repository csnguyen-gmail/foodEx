...
- (UIView *)getViewAtIndex:(NSUInteger)index {
    ...
    UILabel *nameLbl = [[UILabel alloc] initWithFrame:CGRectMake(11.0, 3.0, 151.0, 21.0)];
    nameLbl.textColor = [UIColor whiteColor];
    nameLbl.backgroundColor = [UIColor clearColor];
    nameLbl.text = self.name;
    
    DYRateView *ratingView = [[DYRateView alloc] initWithFrame:CGRectMake(169.0, 8.0, 66.0, 12.0)];
